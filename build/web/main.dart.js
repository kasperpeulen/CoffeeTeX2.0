...
["dart.dom.html", "dart:html", , W, {
  ...
  InputElement: {
    "^": "HtmlElement;placeholder},selectionEnd=,selectionStart%,type},value%",
    select$0: function(receiver) {
  ...
  TextAreaElement: {
    "^": "HtmlElement;placeholder},selectionEnd=,selectionStart%,value%",
    select$0: function(receiver) {
      return receiver.select();
    },
    setSelectionRange$3: function(receiver, start, end, direction) {
...
["getCaretXYFromTextArea", "getCaretXYFromTextArea.dart", , R, {
  "^": "",
  getCaretXYFromTextArea: function(element, position) {
    var div, style, t1, computed, t2, t3, prop, t4, propValue, span, t5, t6, caret_XY;
    div = document.createElement("div", null);
    div.id = "input-textarea-caret-position-mirror-div";
    document.body.appendChild(div);
    style = div.style;
    t1 = J.getInterceptor$x(element);
    computed = t1.getComputedStyle$0(element);
    J.getInterceptor$x(style).set$whiteSpace(style, "pre-wrap");
    C.CssStyleDeclaration_methods.set$wordWrap(style, "break-word");
    C.CssStyleDeclaration_methods.set$position(style, "absolute");
    C.CssStyleDeclaration_methods.set$border(style, "1px solid black");
    C.CssStyleDeclaration_methods.set$overflow(style, "hidden");
    for (t2 = new H.ListIterator($.get$properties(), 28, 0, null), t3 = J.getInterceptor$x(computed); t2.moveNext$0();) {
      prop = t2.__internal$_current;
      t4 = div.style;
      propValue = t3._getPropertyValueHelper$1(computed, prop);
      J.setProperty$2$x(t4, prop, propValue != null ? propValue : "");
    }
    div.textContent = J.substring$2$s(t1.get$value(element), 0, position);
    span = document.createElement("span", null);
    if (J.substring$1$s(t1.get$value(element), position) === "")
      span.textContent = ".";
    else
      span.textContent = J.substring$1$s(t1.get$value(element), position);
    div.appendChild(span);
    t1 = C.JSNumber_methods.toInt$0(C.JSNumber_methods.roundToDouble$0(element.offsetTop));
    t2 = C.JSNumber_methods.toInt$0(C.JSNumber_methods.roundToDouble$0(span.offsetTop));
    t3 = t3.getPropertyValue$1(computed, "border-top-width");
    if (0 >= t3.length)
      return H.ioore(t3, 0);
    t3 = H.Primitives_parseInt(t3[0], null, null);
    if (typeof t3 !== "number")
      return H.iae(t3);
    t4 = C.JSNumber_methods.toInt$0(C.JSNumber_methods.roundToDouble$0(element.offsetLeft));
    t5 = C.JSNumber_methods.toInt$0(C.JSNumber_methods.roundToDouble$0(span.offsetLeft));
    t6 = C.CssStyleDeclaration_methods.getPropertyValue$1(computed, "border-left-width");
    if (0 >= t6.length)
      return H.ioore(t6, 0);
    t6 = H.Primitives_parseInt(t6[0], null, null);
    if (typeof t6 !== "number")
      return H.iae(t6);
    caret_XY = P.LinkedHashMap_LinkedHashMap$_literal(["top", t1 + t2 + t3, "left", t4 + t5 + t6], null, null);
    J.remove$0$ax(div);
    return caret_XY;
  }
}],
...
["", "main.dart", , F, {
  ...
  main: [function() {
    ...
    if (J.contains$1$asx(window.navigator.userAgent, "NET"))
      $.modKey2 = [17];
    if ($.get$local().getItem("replaceLetter4") != null)
      $.replaceLetter = C.JsonCodec_null_null.decode$1($.get$local().getItem("replaceLetter4"));
    else
      $.replaceLetter = $.get$replaceLetterDefault();
    var t1 = document.body;
    t1.toString;
    t1 = H.setRuntimeTypeInfo(new W._ElementEventStreamImpl(t1, "keydown", false), [null]);
    t1 = H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(F.onKeyDown$closure()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)]);
    t1._tryResume$0();
    $.listenBody = t1;
    t1 = J.get$onClick$x($.get$settings());
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(F.settingsClicked$closure()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
  ...
  createPopUp: function() {
    var t1, t2, t3, $char, li, addChar;
    t1 = $.get$textarea();
    $.caret_XY = R.getCaretXYFromTextArea(t1, J.get$selectionStart$x(t1));
    t1 = document.createElement("div", null);
    t1.id = "popup";
    J.set$display$x(t1.style, "block");
    t2 = t1.style;
    t3 = $.caret_XY.$index(0, "top");
    if (typeof t3 !== "number")
      return H.iae(t3);
    J.set$top$x(t2, C.JSNumber_methods.toString$0(25 + t3) + "px");
    t3 = t1.style;
    t2 = $.caret_XY.$index(0, "left");
    if (typeof t2 !== "number")
      return H.iae(t2);
    J.set$left$x(t3, C.JSNumber_methods.toString$0(-10 + t2) + "px");
    $.popup = t1;
    ...
    t1 = J.get$selectionStart$x($.get$textarea());
    t2 = J.get$selectionEnd$x($.get$textarea());
    ...
    addChar = document.createElement("li", null);
    J.set$minWidth$x(addChar.style, "5px");
    addChar.id = "addChar";
  ...
  selectCharIndex: function(i) {
    ...
    t1 = J.get$children$x($.char_list).$index(0, i);
    $.selected = t1;
    J.get$classes$x(t1).add$1(0, "selected");
    $.selectedCharIndex = i;
    t1 = $.listen;
    if (t1 != null)
      t1.cancel$0();
  ...
  replaceChar: function() {
    var t1, t2, t3, newChar, dCaretPos, newText, i, newCaretPos;
    t1 = J.$index$asx($.newChars, $.selectedCharIndex);
    t2 = $.selectedCharIndex;
    t3 = $.newChars;
    if (typeof t1 === "string") {
      newChar = J.$index$asx(t3, t2);
      dCaretPos = "0";
    } else {
      newChar = J.$index$asx(J.$index$asx(t3, t2), 0);
      dCaretPos = J.$index$asx(J.$index$asx($.newChars, $.selectedCharIndex), 1);
    }
    if ($.get$replaceLetterAfter().containsKey$1(0, newChar))
      newChar = $.get$replaceLetterAfter().$index(0, newChar);
    newText = J.split$1$s(J.get$value$x($.get$textarea()), "");
    for (i = 1; i <= $.oldChars.length; ++i) {
      t1 = J.get$selectionEnd$x($.get$textarea());
      if (typeof t1 !== "number")
        return t1.$sub();
      t1 -= i;
      if (t1 < 0 || t1 >= newText.length)
  ...
  updateChar: function() {
    ...
    if (updatedChar === "") {
      ...
      if (t1.get$length(t1) === 2) {
        J.removeAt$1$ax(J.$index$asx($.replaceLetter, $.oldChars), $.selectedCharIndex);
        F.removePopUp();
      } else {
        if (J.get$classes$x($.selected).readClasses$0().contains$1(0, "new"))
          $.selectedCharIndex = $.lastCharIndex;
        else
          J.removeAt$1$ax(J.$index$asx($.replaceLetter, $.oldChars), $.selectedCharIndex);
        J.remove$0$ax($.selected);
      ...
      t2 = $.replaceLetter;
      if (i === 0) {
        J.add$1$ax(J.$index$asx(t2, t1), [updatedChar, "0"]);
        J.set$text$x($.selected, updatedChar);
      } else
        J.add$1$ax(J.$index$asx(t2, t1), ["", updatedChar]);
      ...
      t3 = $.replaceLetter;
      if (typeof t1 === "string") {
        J.$indexSet$ax(J.$index$asx(t3, t2), $.selectedCharIndex, updatedChar);
        J.set$text$x($.selected, updatedChar);
      } else {
        J.$indexSet$ax(J.$index$asx(J.$index$asx(t3, t2), $.selectedCharIndex), i, updatedChar);
        J.set$text$x($.selected, J.$index$asx(J.$index$asx(J.$index$asx($.replaceLetter, $.oldChars), $.selectedCharIndex), 0));
      }
    }
    $.get$local().setItem("replaceLetter4", C.JsonCodec_null_null.encode$1($.replaceLetter));
  ...
  addNewChar: [function(e) {
    var t1, t2, t3, first;
    t1 = H.interceptedTypeCast(J.get$target$x(e), "$isLIElement");
    t2 = document.createElement("li", null);
    t2.textContent = "";
    J.get$classes$x(t2).add$1(0, "new");
    t1.toString;
    if (!!t1.insertAdjacentElement)
      t1.insertAdjacentElement("beforebegin", t2);
    else
      switch ("beforebegin".toLowerCase()) {
        case "beforebegin":
        ...
        case "afterend":
          ...
          break;
        default:
          H.throwExpression(P.ArgumentError$("Invalid position beforebegin"));
      }
  ...
  settingsClicked: [function(e) {
    ...
    t3 = $.get$settings();
    t3.toString;
    J.set$top$x(t2, C.JSInt_methods.toString$0(C.JSNumber_methods.toInt$0(C.JSNumber_methods.roundToDouble$0(t3.offsetTop)) - 3) + "px");
    t3 = t1.style;
    t2 = $.get$settings();
    t2.toString;
    J.set$left$x(t3, C.JSInt_methods.toString$0(C.JSNumber_methods.toInt$0(C.JSNumber_methods.roundToDouble$0(t2.offsetLeft))) + "px");
    $.popup = t1;
    document.body.appendChild(t1);
    t1 = document.createElement("ul", null);
    t1.id = "char_list";
    $.char_list = t1;
    input = W.InputElement_InputElement(null);
    t1 = J.getInterceptor$x(input);
    t1.set$type(input, "text");
    input.id = "changeChar";
    J.set$width$x(input.style, "180px");
    t1.set$placeholder(input, "Press new modifier key");
    $.popup.appendChild(input);
    t1.select$0(input);
    t1.setSelectionRange$2(input, 0, 0);
    t1 = t1.get$onKeyDown(input);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new F.settingsClicked_closure()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
  }, "call$1", "settingsClicked$closure", 2, 0, 11],
  ...
  settingsClicked_closure: {
    "^": "Closure:14;",
    call$1: function(e) {
      var t1 = J.getInterceptor$x(e);
      t1.preventDefault$0(e);
      $.modKey2 = [t1.get$keyCode(e)];
      J.remove$0$ax($.popup);
      $.popup = null;
    }
  }
...
J.get$selectionEnd$x = function(receiver) {
  return J.getInterceptor$x(receiver).get$selectionEnd(receiver);
};
J.get$selectionStart$x = function(receiver) {
  return J.getInterceptor$x(receiver).get$selectionStart(receiver);
};
...
Isolate.$lazy($, "properties", "properties", "get$properties", function() {
  return ["direction", "box-sizing", "width", "height", "overflowX", "overflowY", "border-top-width", "border-right-width", "border-bottom-width", "border-left-width", "padding-top", "padding-right", "padding-bottom", "padding-left", "font-style", "font-variant", "font-weight", "font-stretch", "font-size", "font-size-adjust", "line-height", "font-family", "text-align", "text-transform", "text-indent", "text-decoration", "letter-spacing", "word-spacing"];
});
Isolate.$lazy($, "textarea", "textarea", "get$textarea", function() {
  return document.querySelector("#ct_editor");
});
Isolate.$lazy($, "settings", "settings", "get$settings", function() {
  return document.querySelector("#settings");
});
Isolate.$lazy($, "local", "local", "get$local", function() {
  return window.localStorage;
});
Isolate.$lazy($, "modKey", "modKey", "get$modKey", function() {
  return [92, 93];
});
Isolate.$lazy($, "modKey2", "modKey2", "get$modKey2", function() {
  return [18];
});
